...
export default function GreetingPage() {
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <PageBanner 
        title="인사말"
        subtitle="선함노동사무소의 철학과 비전을 소개합니다"
            ...
            <div className="px-4 md:px-0">
              ...
              <div className="mb-6">
                ...
                <div className="text-sm sm:text-base text-foreground leading-relaxed">
                  <p className="mb-4">
                    선함노동사무소는 2020년 설립된 이후, 기업자문에 컨설팅 개념을 도입하여 기업자문의 새로운 지평을 열었다는 평가를 받고 있습니다.
                    <br className="hidden sm:block" />
                    그 결과 현재 국내외 100여 업체의 기업고객에게 전문적인 자문서비스를 제공하고 있습니다.
                  </p>
                  <p className="mb-4">
                    또한 선함노동사무소는 대기업 및 외국계 기업에 대한 자문외에도 하나님의 공의와 사랑을 추구하는 선함 노동상담실과 도서출판 선함을 부설기관으로 운영하고 있습니다.
                  </p>
                  <p className="mb-4">
                  ...
                  <p className="mb-6">
                    법률지식을 넘어 문제를 해결할 수 있는 전략을 원한다면, 선함노동사무소와 만나십시오.
